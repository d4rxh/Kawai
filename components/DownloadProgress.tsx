    ...
    <AnimatePresence>
        <div className="fixed bottom-24 md:bottom-28 left-0 right-0 z-[200] flex justify-center pointer-events-none">
            <motion.div
                ...
                className="bg-[#130018] rounded-full pl-2 pr-6 py-2 flex items-center gap-4 min-w-[280px]"
            >
                ...
                <div className="relative w-12 h-12 shrink-0">
                    ...
                    {/* Image or Checkmark */}
                    <div className="absolute inset-[6px] rounded-full overflow-hidden bg-[#2A0038] flex items-center justify-center">
                ...
                <div className="flex flex-col flex-1 min-w-0">
                    ...
                    <motion.span 
                        layout
                        className="text-[#D4A0BA] text-xs truncate"
                    >
