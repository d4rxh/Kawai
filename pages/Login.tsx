...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col p-8 overflow-hidden" style={{background:'linear-gradient(160deg,#0A000F 0%,#1E0030 50%,#0A000F 100%)'}}>
      ...
      >
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate('/')}>
            <svg width="36" height="36" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect width="512" height="512" rx="115" fill="url(#loginGrad)"/>
            ...
            <div className="flex flex-col leading-none">
              <span className="text-white font-bold text-base tracking-wide">Kawai Sakura</span>
      ...
      >
        ...
        <div className="w-full max-w-[324px] sm:max-w-[400px] flex flex-col gap-6 md:gap-8">
            <motion.h1 variants={itemVariants} className="text-3xl md:text-5xl font-black tracking-tighter text-center mb-4">Log in to Kawai Sakura</motion.h1>
            ...
            <motion.form variants={itemVariants} onSubmit={handleLogin} className="flex flex-col gap-4">
               ...
               <div className="flex flex-col gap-2">
                  ...
                  <input 
                    type="email" 
                    required
                    className="bg-[#1A0025] border border-[#FF6B9D]/30 rounded-[4px] px-3.5 py-3.5 text-white focus:outline-none focus:border-[#FF6B9D] focus:ring-1 focus:ring-[#FF6B9D]/50 transition-colors placeholder-[#D4A0BA]/50"
               ...
               <motion.button 
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="font-bold text-base py-3.5 rounded-full mt-4 flex items-center justify-center uppercase tracking-widest transition-all hover:brightness-110"
                  style={{background:'linear-gradient(135deg,#FF6B9D,#C2185B)',color:'white'}}
               >
            ...
            <motion.div variants={itemVariants} className="flex flex-col items-center gap-4 mt-2">
                ...
                <div className="flex items-center gap-2 text-[#B3B3B3] text-sm md:text-base">
                    ...
                    <Link to="/signup" className="text-[#FF6B9D] hover:text-[#FFB7C5] hover:underline font-bold transition-colors">Sign up for Kawai Sakura</Link>
                </div>
            </motion.div>
